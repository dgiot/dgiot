:: The batch file for dgiot_ctl command
...
@set dgiot_conf=%rel_root_dir%\etc\dgiot.conf
...
@%escript% %nodetool% %node_type% "%node_name%" -setcookie "%node_cookie%" rpc dgiot_ctl run_command %args%
