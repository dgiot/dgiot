...
d_field_FileDescriptorProto_extension(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_FieldDescriptorProto(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_FileDescriptorProto(RestF, 0, 0,
...
d_field_DescriptorProto_oneof_decl(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_OneofDescriptorProto(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_DescriptorProto(RestF, 0, 0, F@_1,
...
d_field_ServiceDescriptorProto_method(<<0:1, X:7,
    ...
    {NewFValue, RestF} = begin
			   Len = X bsl N + Acc,
			   <<Bs:Len/binary, Rest2/binary>> = Rest,
			   {id(decode_msg_MethodDescriptorProto(Bs, TrUserData),
			       TrUserData),
			    Rest2}
			 end,
    dfp_read_field_def_ServiceDescriptorProto(RestF, 0, 0,
...
d_field_UninterpretedOption_double_value(<<0:48, 240,
    ...
    dfp_read_field_def_UninterpretedOption(Rest, Z1, Z2,
					   F@_1, F@_2, F@_3, F@_4,
					   id(infinity, TrUserData), F@_6, F@_7,
					   TrUserData);
d_field_UninterpretedOption_double_value(<<0:48, 240,
					   255, Rest/binary>>,
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4, _,
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      'DescriptorProto.ExtensionRange' ->
	  'v_msg_DescriptorProto.ExtensionRange'(Msg, [MsgName],
						 TrUserData);
      'DescriptorProto.ReservedRange' ->
	  'v_msg_DescriptorProto.ReservedRange'(Msg, [MsgName],
						TrUserData);
      'DescriptorProto' ->
      ...
      'EnumValueDescriptorProto' ->
	  v_msg_EnumValueDescriptorProto(Msg, [MsgName],
					 TrUserData);
      'ServiceDescriptorProto' ->
	  v_msg_ServiceDescriptorProto(Msg, [MsgName],
				       TrUserData);
      'MethodDescriptorProto' ->
      ...
      'UninterpretedOption.NamePart' ->
	  'v_msg_UninterpretedOption.NamePart'(Msg, [MsgName],
					       TrUserData);
      'UninterpretedOption' ->
	  v_msg_UninterpretedOption(Msg, [MsgName], TrUserData);
      'SourceCodeInfo.Location' ->
	  'v_msg_SourceCodeInfo.Location'(Msg, [MsgName],
					  TrUserData);
      'SourceCodeInfo' ->
	  v_msg_SourceCodeInfo(Msg, [MsgName], TrUserData);
      'GeneratedCodeInfo.Annotation' ->
	  'v_msg_GeneratedCodeInfo.Annotation'(Msg, [MsgName],
					       TrUserData);
      'GeneratedCodeInfo' ->
...
v_msg_FileDescriptorSet(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'FileDescriptorSet'}, X,
		  Path).
...
v_msg_FieldOptions(#'FieldOptions'{ctype = F1,
    ...
    if F1 == undefined -> ok;
       true ->
	   'v_enum_FieldOptions.CType'(F1, [ctype | Path],
				       TrUserData)
    end,
    if F2 == undefined -> ok;
...
v_msg_GeneratedCodeInfo(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'GeneratedCodeInfo'}, X,
		  Path).
...
get_msg_names() ->
    ['FileDescriptorSet', 'FileDescriptorProto',
     'DescriptorProto.ExtensionRange',
     'DescriptorProto.ReservedRange', 'DescriptorProto',
     ...
     'MethodOptions', 'UninterpretedOption.NamePart',
     'UninterpretedOption', 'SourceCodeInfo.Location',
...
get_msg_containment("descriptor") ->
    ['DescriptorProto', 'DescriptorProto.ExtensionRange',
     ...
     'FileDescriptorSet', 'FileOptions', 'GeneratedCodeInfo',
     'GeneratedCodeInfo.Annotation', 'MessageOptions',
...
get_enum_containment("descriptor") ->
    ['FieldDescriptorProto.Label',
     'FieldDescriptorProto.Type', 'FieldOptions.CType',
     'FieldOptions.JSType', 'FileOptions.OptimizeMode'];
