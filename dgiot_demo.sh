...
function pre_build_dgiot() {
    ...
    if [ -d ${script_dir}/dgiot_lowcode/dist ]; then
      rm ${script_dir}/$plugin/apps/dgiot_api/priv/www/ -rf
      cp ${script_dir}/dgiot_lowcode/guide/  ${script_dir}/$plugin/apps/dgiot_api/priv/www -rf
      cp ${script_dir}/dgiot_lowcode/dist/  ${script_dir}/$plugin/apps/dgiot_api/priv/www/amis -rf
    fi
