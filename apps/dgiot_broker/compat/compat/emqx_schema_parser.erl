%% @doc 同名门面：emqx_schema_parser —— 仅在「无 EMQX 模式」下编译（刀 6 切换）。
%%
...
decode(_A0, _A1, _A2) ->
    {error, {not_implemented, cut7, emqx_schema_parser, decode}}.

encode(_A0, _A1, _A2) ->
    {error, {not_implemented, cut7, emqx_schema_parser, encode}}.
