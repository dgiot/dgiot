...
get_service_names() -> ['dgiot.exhook.v1.HookProvider'].


get_service_def('dgiot.exhook.v1.HookProvider') ->
    {{service, 'dgiot.exhook.v1.HookProvider'},
...
get_rpc_names('dgiot.exhook.v1.HookProvider') ->
    ['OnProviderLoaded',
     'OnProviderUnloaded',
     'OnClientConnect',
     'OnClientConnack',
...
find_rpc_def('dgiot.exhook.v1.HookProvider', RpcName) ->
    'find_rpc_def_dgiot.exhook.v1.HookProvider'(RpcName);
find_rpc_def(_, _) -> error.


'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnProviderLoaded') ->
    #{name => 'OnProviderLoaded',
      input => provider_loaded_request,
      output => loaded_response, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnProviderUnloaded') ->
    #{name => 'OnProviderUnloaded',
      input => provider_unloaded_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnClientConnect') ->
    #{name => 'OnClientConnect',
      input => client_connect_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnClientConnack') ->
    #{name => 'OnClientConnack',
      input => client_connack_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnClientConnected') ->
    #{name => 'OnClientConnected',
      input => client_connected_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnClientDisconnected') ->
    #{name => 'OnClientDisconnected',
      input => client_disconnected_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnClientAuthenticate') ->
    #{name => 'OnClientAuthenticate',
      input => client_authenticate_request,
      output => valued_response, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnClientCheckAcl') ->
    #{name => 'OnClientCheckAcl',
      input => client_check_acl_request,
      output => valued_response, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnClientSubscribe') ->
    #{name => 'OnClientSubscribe',
      input => client_subscribe_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnClientUnsubscribe') ->
    #{name => 'OnClientUnsubscribe',
      input => client_unsubscribe_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnSessionCreated') ->
    #{name => 'OnSessionCreated',
      input => session_created_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnSessionSubscribed') ->
    #{name => 'OnSessionSubscribed',
      input => session_subscribed_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnSessionUnsubscribed') ->
    #{name => 'OnSessionUnsubscribed',
      input => session_unsubscribed_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnSessionResumed') ->
    #{name => 'OnSessionResumed',
      input => session_resumed_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnSessionDiscarded') ->
    #{name => 'OnSessionDiscarded',
      input => session_discarded_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnSessionTakeovered') ->
    #{name => 'OnSessionTakeovered',
      input => session_takeovered_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnSessionTerminated') ->
    #{name => 'OnSessionTerminated',
      input => session_terminated_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnMessagePublish') ->
    #{name => 'OnMessagePublish',
      input => message_publish_request,
      output => valued_response, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnMessageDelivered') ->
    #{name => 'OnMessageDelivered',
      input => message_delivered_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnMessageDropped') ->
    #{name => 'OnMessageDropped',
      input => message_dropped_request,
      output => empty_success, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'('OnMessageAcked') ->
    #{name => 'OnMessageAcked',
      input => message_acked_request, output => empty_success,
      input_stream => false, output_stream => false,
      opts => []};
'find_rpc_def_dgiot.exhook.v1.HookProvider'(_) -> error.
...
fqbin_to_service_name(<<"dgiot.exhook.v1.HookProvider">>) ->
    'dgiot.exhook.v1.HookProvider';
...
service_name_to_fqbin('dgiot.exhook.v1.HookProvider') ->
    <<"dgiot.exhook.v1.HookProvider">>;
...
%% name, as atoms.
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnProviderLoaded">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnProviderLoaded'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnProviderUnloaded">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnProviderUnloaded'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientConnect">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnClientConnect'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientConnack">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnClientConnack'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientConnected">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnClientConnected'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientDisconnected">>) ->
    {'dgiot.exhook.v1.HookProvider',
     'OnClientDisconnected'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientAuthenticate">>) ->
    {'dgiot.exhook.v1.HookProvider',
     'OnClientAuthenticate'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientCheckAcl">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnClientCheckAcl'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientSubscribe">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnClientSubscribe'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientUnsubscribe">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnClientUnsubscribe'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionCreated">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnSessionCreated'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionSubscribed">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnSessionSubscribed'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionUnsubscribed">>) ->
    {'dgiot.exhook.v1.HookProvider',
     'OnSessionUnsubscribed'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionResumed">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnSessionResumed'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionDiscarded">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnSessionDiscarded'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionTakeovered">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnSessionTakeovered'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionTerminated">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnSessionTerminated'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnMessagePublish">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnMessagePublish'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnMessageDelivered">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnMessageDelivered'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnMessageDropped">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnMessageDropped'};
fqbins_to_service_and_rpc_name(<<"dgiot.exhook.v1.HookProvider">>, <<"OnMessageAcked">>) ->
    {'dgiot.exhook.v1.HookProvider', 'OnMessageAcked'};
...
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
                               'OnProviderLoaded') ->
    {<<"dgiot.exhook.v1.HookProvider">>, <<"OnProviderLoaded">>};
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
                               'OnProviderUnloaded') ->
...
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
                               'OnClientDisconnected') ->
    {<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientDisconnected">>};
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
                               'OnClientAuthenticate') ->
    {<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientAuthenticate">>};
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
                               'OnClientCheckAcl') ->
    {<<"dgiot.exhook.v1.HookProvider">>, <<"OnClientCheckAcl">>};
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
...
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
                               'OnSessionUnsubscribed') ->
    {<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionUnsubscribed">>};
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
                               'OnSessionResumed') ->
    {<<"dgiot.exhook.v1.HookProvider">>, <<"OnSessionResumed">>};
service_and_rpc_name_to_fqbins('dgiot.exhook.v1.HookProvider',
...
fqbin_to_msg_name(<<"dgiot.exhook.v1.ProviderLoadedRequest">>) -> provider_loaded_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.LoadedResponse">>) -> loaded_response;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ProviderUnloadedRequest">>) -> provider_unloaded_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientConnectRequest">>) -> client_connect_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientConnackRequest">>) -> client_connack_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientConnectedRequest">>) -> client_connected_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientDisconnectedRequest">>) ->
    client_disconnected_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientAuthenticateRequest">>) ->
    client_authenticate_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientCheckAclRequest">>) -> client_check_acl_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientSubscribeRequest">>) -> client_subscribe_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientUnsubscribeRequest">>) ->
    client_unsubscribe_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.SessionCreatedRequest">>) -> session_created_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.SessionSubscribedRequest">>) ->
    session_subscribed_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.SessionUnsubscribedRequest">>) ->
    session_unsubscribed_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.SessionResumedRequest">>) -> session_resumed_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.SessionDiscardedRequest">>) -> session_discarded_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.SessionTakeoveredRequest">>) ->
    session_takeovered_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.SessionTerminatedRequest">>) ->
    session_terminated_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.MessagePublishRequest">>) -> message_publish_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.MessageDeliveredRequest">>) -> message_delivered_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.MessageDroppedRequest">>) -> message_dropped_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.MessageAckedRequest">>) -> message_acked_request;
fqbin_to_msg_name(<<"dgiot.exhook.v1.EmptySuccess">>) -> empty_success;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ValuedResponse">>) -> valued_response;
fqbin_to_msg_name(<<"dgiot.exhook.v1.BrokerInfo">>) -> broker_info;
fqbin_to_msg_name(<<"dgiot.exhook.v1.HookSpec">>) -> hook_spec;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ConnInfo">>) -> conn_info;
fqbin_to_msg_name(<<"dgiot.exhook.v1.ClientInfo">>) -> client_info;
fqbin_to_msg_name(<<"dgiot.exhook.v1.Message">>) -> message;
fqbin_to_msg_name(<<"dgiot.exhook.v1.Property">>) -> property;
fqbin_to_msg_name(<<"dgiot.exhook.v1.TopicFilter">>) -> topic_filter;
fqbin_to_msg_name(<<"dgiot.exhook.v1.SubOpts">>) -> sub_opts;
fqbin_to_msg_name(E) -> error({gpb_error, {badmsg, E}}).


msg_name_to_fqbin(provider_loaded_request) -> <<"dgiot.exhook.v1.ProviderLoadedRequest">>;
msg_name_to_fqbin(loaded_response) -> <<"dgiot.exhook.v1.LoadedResponse">>;
msg_name_to_fqbin(provider_unloaded_request) -> <<"dgiot.exhook.v1.ProviderUnloadedRequest">>;
msg_name_to_fqbin(client_connect_request) -> <<"dgiot.exhook.v1.ClientConnectRequest">>;
msg_name_to_fqbin(client_connack_request) -> <<"dgiot.exhook.v1.ClientConnackRequest">>;
msg_name_to_fqbin(client_connected_request) -> <<"dgiot.exhook.v1.ClientConnectedRequest">>;
msg_name_to_fqbin(client_disconnected_request) ->
    <<"dgiot.exhook.v1.ClientDisconnectedRequest">>;
msg_name_to_fqbin(client_authenticate_request) ->
    <<"dgiot.exhook.v1.ClientAuthenticateRequest">>;
msg_name_to_fqbin(client_check_acl_request) -> <<"dgiot.exhook.v1.ClientCheckAclRequest">>;
msg_name_to_fqbin(client_subscribe_request) -> <<"dgiot.exhook.v1.ClientSubscribeRequest">>;
msg_name_to_fqbin(client_unsubscribe_request) ->
    <<"dgiot.exhook.v1.ClientUnsubscribeRequest">>;
msg_name_to_fqbin(session_created_request) -> <<"dgiot.exhook.v1.SessionCreatedRequest">>;
...
msg_name_to_fqbin(session_unsubscribed_request) ->
    <<"dgiot.exhook.v1.SessionUnsubscribedRequest">>;
msg_name_to_fqbin(session_resumed_request) -> <<"dgiot.exhook.v1.SessionResumedRequest">>;
msg_name_to_fqbin(session_discarded_request) -> <<"dgiot.exhook.v1.SessionDiscardedRequest">>;
msg_name_to_fqbin(session_takeovered_request) ->
    <<"dgiot.exhook.v1.SessionTakeoveredRequest">>;
msg_name_to_fqbin(session_terminated_request) ->
    <<"dgiot.exhook.v1.SessionTerminatedRequest">>;
msg_name_to_fqbin(message_publish_request) -> <<"dgiot.exhook.v1.MessagePublishRequest">>;
msg_name_to_fqbin(message_delivered_request) -> <<"dgiot.exhook.v1.MessageDeliveredRequest">>;
msg_name_to_fqbin(message_dropped_request) -> <<"dgiot.exhook.v1.MessageDroppedRequest">>;
msg_name_to_fqbin(message_acked_request) -> <<"dgiot.exhook.v1.MessageAckedRequest">>;
msg_name_to_fqbin(empty_success) -> <<"dgiot.exhook.v1.EmptySuccess">>;
msg_name_to_fqbin(valued_response) -> <<"dgiot.exhook.v1.ValuedResponse">>;
msg_name_to_fqbin(broker_info) -> <<"dgiot.exhook.v1.BrokerInfo">>;
msg_name_to_fqbin(hook_spec) -> <<"dgiot.exhook.v1.HookSpec">>;
msg_name_to_fqbin(conn_info) -> <<"dgiot.exhook.v1.ConnInfo">>;
msg_name_to_fqbin(client_info) -> <<"dgiot.exhook.v1.ClientInfo">>;
msg_name_to_fqbin(message) -> <<"dgiot.exhook.v1.Message">>;
msg_name_to_fqbin(property) -> <<"dgiot.exhook.v1.Property">>;
msg_name_to_fqbin(topic_filter) -> <<"dgiot.exhook.v1.TopicFilter">>;
msg_name_to_fqbin(sub_opts) -> <<"dgiot.exhook.v1.SubOpts">>;
msg_name_to_fqbin(E) -> error({gpb_error, {badmsg, E}}).


fqbin_to_enum_name(<<"dgiot.exhook.v1.ClientCheckAclRequest.AclReqType">>) ->
    'client_check_acl_request.AclReqType';
fqbin_to_enum_name(<<"dgiot.exhook.v1.ValuedResponse.ResponsedType">>) ->
    'valued_response.ResponsedType';
...
enum_name_to_fqbin('client_check_acl_request.AclReqType') ->
    <<"dgiot.exhook.v1.ClientCheckAclRequest.AclReqType">>;
enum_name_to_fqbin('valued_response.ResponsedType') ->
    <<"dgiot.exhook.v1.ValuedResponse.ResponsedType">>;
enum_name_to_fqbin(E) ->
    error({gpb_error, {badenum, E}}).


get_package_name() -> 'dgiot.exhook.v1'.
...
get_pkg_containment("exhook") -> 'dgiot.exhook.v1';
...
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.TopicFilter">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.SubOpts">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.HookSpec">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.EmptySuccess">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.SessionUnsubscribedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.SessionTerminatedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.SessionTakeoveredRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.SessionSubscribedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.SessionResumedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.SessionDiscardedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.SessionCreatedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ProviderUnloadedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ProviderLoadedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.MessagePublishRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.MessageDroppedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.MessageDeliveredRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.MessageAckedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientUnsubscribeRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientSubscribeRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientDisconnectedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientConnectedRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientConnectRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientConnackRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientCheckAclRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientAuthenticateRequest">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ValuedResponse">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.Message">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.LoadedResponse">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.Property">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ConnInfo">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.ClientInfo">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(<<"dgiot.exhook.v1.BrokerInfo">>) -> "exhook";
get_proto_by_msg_name_as_fqbin(E) ->
    error({gpb_error, {badmsg, E}}).


get_proto_by_service_name_as_fqbin(<<"dgiot.exhook.v1.HookProvider">>) -> "exhook";
get_proto_by_service_name_as_fqbin(E) ->
    error({gpb_error, {badservice, E}}).


get_proto_by_enum_name_as_fqbin(<<"dgiot.exhook.v1.ValuedResponse.ResponsedType">>) -> "exhook";
get_proto_by_enum_name_as_fqbin(<<"dgiot.exhook.v1.ClientCheckAclRequest.AclReqType">>) -> "exhook";
get_proto_by_enum_name_as_fqbin(E) ->
    error({gpb_error, {badenum, E}}).


get_protos_by_pkg_name_as_fqbin(<<"dgiot.exhook.v1">>) -> ["exhook"];
