...
public class HelloWorldClient {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // Channels are thread-safe and reusable. It is common to create channels at
    // the beginning of your application and reuse them until the application
    // shuts down.
    ...
    try {
      ...
      // prevent leaking these resources the channel should be shut down when it
