...
_HELLOREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="dgiot.HelloRequest.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_HELLOREPLY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="message",
            full_name="dgiot.HelloReply.message",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_HEALTHCHECKREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="service",
            full_name="dgiot.HealthCheckRequest.service",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_HEALTHCHECKRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="status",
            full_name="dgiot.HealthCheckResponse.status",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
