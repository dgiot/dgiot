...
overlay_vars_rel(RelType) ->
    ...
    [{enable_plugin_emqx_rule_engine, RelType =:= cloud}
        ...
        , {enable_plugin_dgiot_tdenginex, true}
        ...
        , {enable_plugin_dgiot_dahua, true}
        , {enable_plugin_dgiot_current, true}
        , {enable_plugin_dgiot_workshop, true}
        , {enable_plugin_dgiot_plc, true}
        , {enable_plugin_dgiot_viewx, true}
        , {enable_plugin_dgiot_sl651, true}
        , {enable_plugin_dgiot_sec, true}
        , {enable_plugin_dgiot_rtsp2ws, true}
        , {enable_plugin_dgiot_sophon, true}
        , {enable_plugin_dgiot_iec104, true}
        , {enable_plugin_dgiot_open62541, true}
        , {vm_args_file, VmArgs}
    ].
