...
-params(#{
    ...
    <<"ico">> => #{
        ...
        type => string,
        required => false,
        default => <<"http://dgiot-1253666439.cos.ap-shanghai-fsi.myqcloud.com/dgiot_tech/zh/product/dgiot/channel/%E8%A7%86%E9%A2%91%E9%87%87%E9%9B%86%E5%9B%BE%E6%A0%87.jpg">>,
        title => #{
            en => <<"channel ICO">>,
            zh => <<"通道ICO"/utf8>>
        },
