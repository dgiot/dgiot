...
-params(#{
    ...
    <<"ico">> => #{
        ...
        type => string,
        required => false,
        default => <<"/dgiot_file/shuwa_tech/zh/product/dgiot/channel/profile_channel.png">>,
        title => #{
            en => <<"channel ICO">>,
            zh => <<"通道ICO"/utf8>>
        },
...
%%    io:format("~s ~p NewQueryData = ~ts ~n", [?FILE, ?LINE, unicode:characters_to_list(jiffy:encode(NewQueryData))]),
