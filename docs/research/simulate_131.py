...
PROCESSES = {
    "pSpaceServer64":  {"ver":"6.0.1.9",  "hb":60, "role":"实时库"},
...
WELLS = [
    {"id":"rtu_001","devaddr":"02110120089","name":"K1_51","ip":"11.66.12.131:502","protocol":"Modbus TCP",
     "points":[
...
DATA_EXPORTS = {
    "Oracle": "11.66.12.129:1521/orcl (DQYTPROD, 966 wells)",
    "pSpace": "11.66.11.131:8889 (力控实时库)",
}
...
def main():
    ...
    print(f"                   pSpace {DATA_EXPORTS['pSpace'][:30]}")
    print()
