...
dev_id = hashlib.md5(b"Device2de1b3e1b8DEV-001").hexdigest()[:10]
...
try:
    r = requests.post("http://127.0.0.1:6041/rest/sql",
        data="SELECT * FROM _85ef6b7459.sub_2de1b3e1b8_DEV-001 ORDER BY ts DESC LIMIT 1",
