...
dev_id = hashlib.md5(b"Device2de1b3e1b8DEVICE_ID_PLACEHOLDER").hexdigest()[:10]
...
PID = "2de1b3e1b8"; D = "DEVICE_ID_PLACEHOLDER"
CID = f"{PID}_{D}"
...
try:
    r = requests.post("http://127.0.0.1:6041/rest/sql",
        data="SELECT * FROM _85ef6b7459.sub_2de1b3e1b8_DEVICE_ID_PLACEHOLDER ORDER BY ts DESC LIMIT 1",
